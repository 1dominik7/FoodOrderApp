    ...
    <div className='w-screen overflow-x-scroll text-red-500'>
        <div className='w-max flex'>
            ...
            <div className='w-screen h-[60vh] flex flex-col items-center justify-around p-4 hover:bg-fuchsia-50 transition-all duration-300 md:w-[50vw] xl:w-[33vw] xl:h-[90vh]' key={item.id}>
               {item.img && 
               <div className='relative flex-1 w-full hover:rotate-[60deg] transition-all duration 500' key={item.id}>
                ...
                <div className='flex-1 flex flex-col items-center justify-center text-center gap-4 z-10'>
                    ...
                    <Link href={`/product/${item.id}`} className='bg-red-500 text-white p-2 rouded-md'>Add to Cart</Link>
                </div>
            </div>))}
        </div>
    </div>
